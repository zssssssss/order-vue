    ...
    <el-drawer
      ...
      <div class="drawerBox flexCC">
        <el-card class="elCard" style="">
          <div class="pointer flexCC" @click="beforeAdd">筛选</div>
        </el-card>
        <el-card class="elCard">
          <div class="pointer flexCC sqlBox" @click.self="setSqlVisible">
            <span>统计图</span>
          </div>

          <div class="inputSql" :class="sqlVisible && drawerV ? 'inputSql2' : ''">
            <h1 style="text-align: left; margin-left: 30px">Sql语句执行</h1>
